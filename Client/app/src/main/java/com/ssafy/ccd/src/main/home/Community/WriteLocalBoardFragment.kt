 ...
 * 울동네 게시글 작성 화면
 */
class WriteLocalBoardFragment : BaseFragment<FragmentWriteLocalBoardBinding>(FragmentWriteLocalBoardBinding::bind, R.layout.fragment_write_local_board) {
    private val TAG = "WriteLocalBoardF_ccd"
